...
QuiTollisViolinoI = {
  \relative c' {
    ...
    h h,(-. h-. h-. h-. h-.) h1 r2\fermata \bar "||" %304 finis
  }
}
...
QuoniamViolinoI = {
  \relative c' {
    ...
    \tuplet 3/2 4 { d8[( cis d] d cis d) \mvTr h'!\f-\markup \remark "Ob. loco" a g c[ h a] }
...
CumSanctoViolinoI = {
  \relative c' {
    ...
    \tempoCumSanctoB c2 h a h1 r2\fermata \bar "||"
    ...
    h h16 h e8 e a, h c d
    e4. d16 c h8 e, e' d
    c d e8.(\trill dis?32 e) fis8.(\trill e32 fis) gis8.(\trill fis32 gis)
    <a c, e, a,>4 c, gis g
    f2 e4 a %445
    b8 c d4. a8 d4~
...
EtUnamSanctamViolinoI = {
  \relative c' {
    ...
    \mvTr h'2\pE-\markup \remark "con sordino" h h c2. h4 c2 %228
    c h a a2. g4 g2
    c c h a2. a4 h2 %230
    h h a h1 r2
    r r h cis2. h4 cis2
...
SanctusViolinoI = {
  \relative c' {
    ...
    \time 6/4 \set Staff.timeSignatureFraction = 3/4 \tempoPleni
      e16-!-\markup \remark "staccato" c-! c-! c e-! e-! e e g g g g e e e e g g g g c c c c
...
OsannaViolinoI = {
  \relative c' {
    ...
    \tempoOsannaFinis f2~ f8 f e2 r4\fermata \bar "|." %127 FINIS
  }
}
