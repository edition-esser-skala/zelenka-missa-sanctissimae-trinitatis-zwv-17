...
QuiTollisOboeI = {
  \relative c' {
    ...
    h2^\critnote r r r1*3/2\fermata \bar "||" %304 finis
  }
}
...
QuoniamOboeI = {
  \relative c' {
    ...
    R1*2
    r4 r8 h\f e8. dis16 e8. fis16
    h,8. dis16 e8. fis16 h,8 \mvTr r r4
    R1*33 %362
    r2 r4 r8 fis\f
    ...
    d4 d, g r
    R1*24 %407
    e'8.\f dis16 e8. fis16 h,8. dis16 e8. fis16
    h,4 r r2
    R1*2 %411
    r4 \tempoQuoniamB r^\adlibitumE r r8 r16 h
...
CumSanctoOboeI = {
  \relative c' {
    ...
    \tempoCumSanctoB c,2 e e e1 r2\fermata \bar "||"
...
CredoOboeI = {
  \relative c' {
    ...
    g-! c-! r e, f4 g %125
    c-\critnote r r2\fermata \bar "||" %126 FINIS
  }
}
...
SanctusOboeI = {
  \relative c' {
    ...
    c4 r r8 h c4 r r\fermata \bar "||" %38 finis
  }
}
...
DonaNobisOboeI = {
  \relative c' {
    ...
    c'4.\fE c8 h4 e8 d %58
    c d e a, f'2~
    f4 f8 f e2 %60
    f,8 f f f \tuplet 3/2 8 { e16([ gis h)] e( h a) gis([ h a)] gis( fis e)
    a([ c e)] a( e d) c([ e d)] c( h a) } \tempoAgnusDeiUltimusFinis c8 c c c
    c c h a h h h h
