...
ChristeFlautoI = {
  \relative c' {
    ...
    \appoggiatura dis16 e8.([\trill d?32 cis)] h16 d cis32( e16.) fis32([ a,16.)] gis32( d'16.) %95
...
BenedictusFlautoI = {
  \relative c' {
    ...
    a16. c,32 h16. a32  h8 gis' a4 r\fermata \bar "||" %117 finis
  }
}
