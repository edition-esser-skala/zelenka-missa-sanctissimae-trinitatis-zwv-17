...
GloriaViolinoII = {
  \relative c' {
    ...
    \mvTr a'8\fE-\markup \remark "staccato" a, a' a, a' a,
...
QuoniamViolinoII = {
  \relative c' {
    ...
    \tuplet 3/2 4 { d,8 d' c b[ a g] } fis8.-\markup \remarkE "Ob. 8va" d16 g8. cis,16 %380
    \tuplet 3/2 4 { d8[ cis d] d cis d } fis8.(\p d16) g8.( cis,16)
    \tuplet 3/2 4 { d8[( cis d] d cis d) \mvTr h'!\f-\markup \remarkE "Ob. loco" a g c[ h a] }
...
EtUnamSanctamViolinoII = {
  \relative c' {
    ...
    \mvTr g'2\pE-\markup \remark "con sordino" g g a2. g4 a2 %228
    a g fis fis2. e4 e2
...
SanctusViolinoII = {
  \relative c' {
    ...
    \time 6/4 \set Staff.timeSignatureFraction = 3/4 \tempoPleni
      c16-!-\markup \remark "staccato" c c c c c c c e e e e c c c c e e e e g g g g
    ...
    c, c' c c d, c' c c d, h' h h c4-! r r\fermata \bar "||" %38 finis
  }
}
...
BenedictusViolinoII = {
  \relative c' {
    ...
    \tuplet 3/2 8 { a e' c a[ e' c] a[ c a] a c a } e8 e' c c
    h gis16 a h8 gis a4 h8 gis'
    ...
    \appoggiatura dis? e4 r8 d? c16 e a a, h8.\trill a16
    \tuplet 3/2 8 { a e' c a[ e' c] a[ c a] a c a } e8 e' c c
    h gis16 a h8 gis a4 h8 gis' %115
    \tuplet 3/2 8 { a16[-! g-! f-!] g f e f[ e d] e d c } h-! e -! a, a' h,8 gis'
    a16. c,32 h16. a32  e'8 e, a4 r\fermata \bar "||" %117 finis
  }
}
...
OsannaViolinoII = {
  \relative c' {
    ...
    \tempoOsannaFinis d2~ d8 d cis2 r4\fermata \bar "|." %127 FINIS
  }
}
...
DonaNobisViolinoII = {
  \relative c' {
    ...
    c'8-!\fE r c-! r h r h r %58
    c r e r d r d r
    h r h r h r h r %60
    a r a r \tuplet 3/2 8 { h16([ gis h)] e( h a) gis([ h a)] gis( fis e)
    a([ c e)] a( e d) c([ e d)] c( h a) } \tempoAgnusDeiUltimusFinis a8 c-! c-! c-!
    c c h a \tuplet 3/2 8 { h16[ e, h'] e h a gis[ h a] gis a h }
    e,8 h' e4 r2\fermata \bar "||" %64 finis
    ...
    e4 f2 e4
    r8 h' gis8.(\trill fis32 gis) a8-! e-! e' cis
    r a fis8.(\trillE e32 fis) g8-! d d' h %75
    r g c h a4 a,
    e''4.^\tenuto e8 e4 e
    dis a' gis d
    cis g' fis c
    ...
    e'4.^\tenutoE e8 e4 e
    dis8 fis dis8.(\trill cis?32 dis) e8-! e,-! h' gis
    r e' cis8.(\trill h32 cis) d8 d, a' fis
    r d' h8.(\trill a32 h) c8 c, g' e
    ...
    a4 a gis d'
    cis g fis\f c'
    gis8 h c h16 a h8. a16 gis8 h %125
    r c c, c' r d r gis,
    r c c, c' r a gis h
    c4 r r2\fermata \bar "|." %128 FINIS
  }
}
